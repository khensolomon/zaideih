...
urlpatterns = [
    ...
    path('test/<int:track_id>', audio.test),
    
    path("played/<int:track_id>", played.track_played, name="track_played"),
    ...
    path('audio/<int:track_id>', audio.streaming, name='serve_audio'),
